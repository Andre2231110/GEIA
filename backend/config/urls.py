...
from api.views import (
    ...
    conversation_list, conversation_messages, conversation_rename, conversation_delete,
    conversation_archive, conversation_unarchive, conversation_archived_list,
...
urlpatterns = [
    ...
    path('api/student/classes/', student_classes),
    path('api/student/doubts/', student_doubts_list),
    path('api/student/doubts/submit/', student_doubt_submit),
    path('api/doubts/<int:pk>/messages/', doubt_messages),
    ...
    path('api/conversations/<int:pk>/unarchive/', conversation_unarchive),
    path('api/conversations/<int:pk>/share/', conversation_share),
    path('api/conversations/archived/', conversation_archived_list),
